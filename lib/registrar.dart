...
class Registrar extends StatefulWidget {
  ...
  const Registrar({Key? key, this.recipeToEdit}) : super(key: key);
...
Future<void> _checkLoggedUser() async {
  ...
  if (userId == null) {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(content: Text('Debes iniciar sesión para agregar recetas')),
    );
    ...
    try {
      Recipe recipe = Recipe(
        ...
        createdAt: _isEditing 
            ? widget.recipeToEdit!.createdAt // Mantener la fecha original si estamos editando
            : _dbHelper.getCurrentDateTime(), // Nueva fecha para recetas nuevas
      );
                        ...
                        children: [
                          ...
                          SizedBox(
                            ...
                            child: ElevatedButton(
                              ...
                              child: Text(
                                _isEditing ? "Actualizar Receta" : "Registrar Receta",
                                style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white,
